    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          <h2>1. Introdução</h2>
          <p>
            Bem-vindo à Floricultura Quatro Estações. Ao utilizar nossos serviços, você concorda com os seguintes termos e condições. 
        ...
        <section className={styles.section}>
          ...
          <p>
            A Floricultura Quatro Estações oferece produtos florais como buquês, arranjos, flores naturais, cestas e outros itens relacionados. 
        ...
        <section className={styles.section}>
          ...
          <p className={styles.contactInfo}>
            <strong>Floricultura Quatro Estações</strong><br />

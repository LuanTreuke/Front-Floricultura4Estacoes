...
test.describe('Carrinho de Compras', () => {
  ...
  test('deve exibir ícone do carrinho no header da home', async ({ page }) => {
    await page.goto('/');
  ...
  test('deve exibir mensagem de carrinho vazio inicialmente', async ({ page }) => {
    await page.goto('/');
  ...
  test('carrinho deve iniciar com contador zerado', async ({ page }) => {
    await page.goto('/');
  ...
  test('deve ser possível adicionar produto ao carrinho', async ({ page }) => {
    await page.goto('/');
  ...
  test('deve navegar para página dedicada do carrinho', async ({ page }) => {
  ...
  test('deve fechar popup do carrinho ao clicar fora', async ({ page }) => {
    await page.goto('/');
  ...
  test('deve exibir botão de finalizar compra no carrinho', async ({ page }) => {
    await page.goto('/');
  ...
  test('deve persistir carrinho no localStorage', async ({ page }) => {
    await page.goto('/');
...
test.describe('Fluxo de Compra', () => {
  test('deve redirecionar para login ao tentar finalizar compra sem estar logado', async ({ page }) => {
    await page.goto('/');
